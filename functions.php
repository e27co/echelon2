...
class E_Judge extends Echelon {
	...
	*/
	 ...
	 */
	public function meta_boxes() {
		add_meta_box( $this->slug."-metabox", __( "Judge Details" ), array( &$this, 'meta_box' ), $this->slug, 'side', 'high' );
	}
	...
	public function meta_box() {
		...
		<tr>
			<td colspan=2>
			<b>Primary Image (244px x 244px)<br /><br /></b>
		...
		<tr>
			<td colspan=2>
			<b>Hover Image (244px x 244px)<br /><br /></b>
...
class E_Satellite extends Echelon {
	...
	public function __construct() {
		$this->slug = "satellite";
		$this->label = "Satellites";
		$this->title = "Satellite Name";
	...
	*/
	...
	public function meta_box() {
		...
		<tr>
			<td colspan=2>
			<b>BG Image (370px x 150px)<br /><br /></b>
			<img id="speaker_image" src="<?php echo $image_src ?>" style="max-width:100%;" />
			<input type="hidden" name="upload_image_id" id="upload_image_id" value="<?php echo $image_id; ?>" />
			<p>
				<input type='button' class='button' value="<?php _e( 'Set Image' ) ?>"  id="set-image" />
		...
		<tr>
			<td colspan=2>
			<b>Hover Image (370px x 150px)<br /><br /></b>
			<img id="speaker_image2" src="<?php echo $image_src2 ?>" style="max-width:100%;" />
			<input type="hidden" name="upload_image_id2" id="upload_image_id2" value="<?php echo $image_id2; ?>" />
			<p>
				<input type='button' class='button' value="<?php _e( 'Set Image' ) ?>"  id="set-image2" />
	...
	if($the_query->have_posts() ){
		...
		while ( $the_query->have_posts() ){
			...
			if($print){
				...
				<div class="span3">
					<a class="speakerImage fancybox" href="#speaker<?php echo $i; ?>" class="speakerimage" data-toggle="">
						<img src="<?php echo $image_src?>" title="<?php echo htmlentitiesx($p->post_title) ?>" alt="<?php echo htmlentitiesx($p->post_title) ?>" class='primaryimg' />
						<img style='display:none' src="<?php echo $image_src2?>" title="<?php echo htmlentitiesx($p->post_title) ?>" alt="<?php echo htmlentitiesx($p->post_title) ?>" class='alternateimg' />
					</a>
					<p class="lead add-top-small"><?php echo htmlentitiesx($p->post_title) ?><br/><span style="font-size:15px"><?php echo $designation;?></span></p>
				</div>
				<!-- LIGHTBOX CONTENT -->
				<div id="speaker<?php echo $i; ?>" class="container lbox">
					<div class="row-fluid">
						<div class="span5"><img src="<?php echo $image_src?>" class="text-center" /></div>
							<div class="span7"> 
								<h3><?php echo htmlentitiesx($p->post_title) ?></h3>
								<p><?php echo $designation;?></p>
								<div class="socials">
								<?php
								if(trim($fb)){
									?><a href="<?php echo $fb; ?>" class="facebook">facebook</a><?php
								}
								if(trim($tw)){
									?><a href="<?php echo $tw; ?>" class="twitter">twitter</a><?php
								}
								if(trim($in)){
									?><a href="<?php echo $in; ?>" class="linkedin">linkedin</a><?php
								}
								?>
							</div>
						</div>
					</div>
					<div class="add-top-med">
					<?php echo nl2br($p->post_content); ?>
					</div>
				</div>
...
function f_judges(){
	...
	if($the_query->have_posts() ){
		...
		while ( $the_query->have_posts() ){
			...
			if($print){
				...
				<div class="span3">
					<a class="speakerImage fancybox" href="#judge<?php echo $i; ?>" class="speakerimage" data-toggle="">
						<img src="<?php echo $image_src?>" title="<?php echo htmlentitiesx($p->post_title) ?>" alt="<?php echo htmlentitiesx($p->post_title) ?>" class='primaryimg' />
						<img style='display:none' src="<?php echo $image_src2?>" title="<?php echo htmlentitiesx($p->post_title) ?>" alt="<?php echo htmlentitiesx($p->post_title) ?>" class='alternateimg' />
					</a>
					<p class="lead add-top-small"><?php echo htmlentitiesx($p->post_title) ?><br/><span style="font-size:15px"><?php echo $designation;?></span></p>
				...
				<!-- LIGHTBOX CONTENT -->
				<div id="judge<?php echo $i; ?>" class="container lbox">
					<div class="row-fluid">
						<div class="span5"><img src="<?php echo $image_src?>" class="text-center" /></div>
							<div class="span7"> 
								<h3><?php echo htmlentitiesx($p->post_title) ?></h3>
	...
	if(!$therearesomespeakers){
			return "Coming soon!<br><br><br><br>";
	}
